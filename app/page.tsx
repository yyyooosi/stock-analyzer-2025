          ...
          <div className="space-y-8">
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              {batchSentiment ? (
                ...
                <p className="text-gray-400">
                  センチメントデータはバッチ処理で自動収集されます。ウォッチリストに追加すると、次回のバッチ処理で分析が開始されます。
                </p>
              )}
            </div>
              ...
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                {batchSentiment && (() => {
                  ...
                  const syntheticPrediction: CrashPrediction = {
                    ...
                    prediction: '',
                    sentiment: {
                      averageNegativeScore: batchSentiment.negative_count > 0
                        ? Math.round((batchSentiment.negative_count / batchSentiment.tweet_count) * 100)
                        : 0,
                      overallSentiment: batchSentiment.sentiment_score > 20 ? 'positive' :
                        batchSentiment.sentiment_score < -20 ? 'negative' : 'neutral',
