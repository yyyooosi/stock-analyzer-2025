// Risk Assessment Service - 共通のリスク評価ロジック
import {
  RiskAssessment,
  RiskIndicator,
  CategoryRiskScore,
...
import { getMarketValuationMetrics } from "@/app/utils/marketData";

// 前回のアセスメント結果を保存（前日比計算用）
...
// 前回のアセスメントをリセット（テスト用）
export function resetPreviousAssessment(): void {
